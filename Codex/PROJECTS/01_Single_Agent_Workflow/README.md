...
Use Codex like one strong worker, not like a committee.

Your job is to turn a messy internal brief into a clean one-page operating note.

## Why This Project Matters

This is the pattern you should master before touching multi-agent orchestration:
