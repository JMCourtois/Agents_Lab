# Project 04: Codebase Task

## Goal

Use Codex on a tiny real codebase task:
...
This is where Codex becomes meaningfully different from a general chat workflow.

You are no longer just asking for advice. You are asking for code work with validation.
